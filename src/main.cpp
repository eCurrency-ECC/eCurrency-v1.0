...
uint256 hashGenesisBlock("0x00000000e98b88f329515645c1a7b7210e02d53fed48acc80cf8e93cadd1f510");
...
const string strMessageMagic = "eCurrency Signed Message:\n";
...
static const int64 nTargetTimespan = 360000;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000e98b88f329515645c1a7b7210e02d53fed48acc80cf8e93cadd1f510");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1425722521;
        block.nBits    = 486604799;
        block.nNonce   = 1856479652;
